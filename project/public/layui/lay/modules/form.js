...
layui.define("layer", function (e) {
    "use strict";
    var i = layui.$, t = layui.layer, a = layui.hint(), n = layui.device(), l = "form", r = ".layui-form", s = "layui-this", u = "layui-hide", o = "layui-disabled", c = function () {
        this.config = {
            verify: {
                required: [/[\S]+/, "必填项不能为空"],
    ...
    c.prototype.set = function (e) {
        ...
        var n = this, c = i(r + function () {
            ...
            select: function() {
                    ...
                    h = function(t, c, f) {
                        ...
                        if(!c) {
                            ...
                            f && m.on("keyup", w).on("blur", function(i) {
                                 ...
                                 */
                                return !e.hasClass(o) && (e.hasClass("layui-select-tips") ? m.val("") : (m.val(z$(e).html().substring(0,z$(e).html().indexOf("<label"))), e.addClass(r)), e.siblings().removeClass(r), h.val(a).removeClass("layui-form-danger"), layui.event.call(this, l, "select(" + n + ")", {
                                        elem: h[0],
                                        value: a,
                                        othis: t
                                    }), x(!0), !1)
                    ...
                    var v = "string" == typeof s.attr("lay-search"),
                        ...
                        m = i(['<div class="' + (v ? "" : "layui-unselect ") + a + (c ? " layui-select-disabled" : "") + '">', '<div class="' + n + '"><input type="text" placeholder="' + p + '" value="' + (d ? f.html() : "") + '" ' + (v ? "" : "readonly") + ' class="layui-input' + (v ? "" : " layui-unselect") + (c ? " " + o : "") + '">', '<i class="layui-edge"></i></div>', '<dl class="layui-anim layui-anim-upbit' + (s.find("optgroup")[0] ? " layui-select-group" : "") + '">' + function(e) {
                            ...
                            return layui.each(e, function(e, a) {
                                /*
                                 * 新增lay-placeholder.自定义类似placeholder的效果
                                 *
                                 */
                                var z$=layui.$;
                                var placeholder = (typeof(z$(a).attr("lay-placeholder")) == "undefined" ? "" : z$(a).attr("lay-placeholder"));
                                0 !== e || a.value ? "optgroup" === a.tagName.toLowerCase() ? i.push("<dt>" + a.label + "</dt>") : i.push('<dd lay-value="' + a.value + '" class="' + (d === a.value ? r : "") + (a.disabled ? " " + o : "") + '">' + a.innerHTML + "<label class=\"layui-placeholder\">"+placeholder+"</label></dd>") : i.push('<dd lay-value="" class="layui-select-tips">' + (a.innerHTML || t) + "</dd>")
                ...
                t.each(function (t, n) {
                    var l = i(this), r = l.attr("lay-skin"), s = (l.attr("lay-text") || "").split("|"), u = this.disabled;
                    "switch" === r && (r = "_" + r);
                    var c = e[r] || e.checkbox;
                    if ("string" == typeof l.attr("lay-ignore"))return l.show();
                    var d = l.next("." + c[0]), f = i(['<div class="layui-unselect ' + c[0] + (n.checked ? " " + c[1] : "") + (u ? " layui-checkbox-disbaled " + o : "") + '" lay-skin="' + (r || "") + '">', {_switch: "<em>" + ((n.checked ? s[0] : s[1]) || "") + "</em><i></i>"}[r] || (n.title.replace(/\s/g, "") ? "<span>" + n.title + "</span>" : "") + '<i class="layui-icon">' + (r ? "&#xe605;" : "&#xe618;") + "</i>", "</div>"].join(""));
                    d[0] && d.remove(), l.after(f), a.call(this, f, c)
                })
            }, radio: function () {
                var e = "layui-form-radio", t = ["&#xe643;", "&#xe63f;"], a = c.find("input[type=radio]"), n = function (a) {
                    var n = i(this), s = "layui-anim-scaleSpring";
                    a.on("click", function () {
                        var u = n[0].name, o = n.parents(r), c = n.attr("lay-filter"), d = o.find("input[name=" + u.replace(/(\.|#|\[|\])/g, "\\$1") + "]");
                ...
                a.each(function (a, l) {
                    var r = i(this), s = r.next("." + e), u = this.disabled;
    ...
    var d = function () {
        var e = i(this), a = f.config.verify, s = null, u = "layui-form-danger", o = {}, c = e.parents(r), d = c.find("*[lay-verify]"), y = e.parents("form")[0], v = c.find("input,select,textarea"), h = e.attr("lay-filter");
        return layui.each(d, function (e, l) {
            var r = i(this), o = r.attr("lay-verify").split("|"), c = r.attr("lay-verType"), d = r.val();
            if (r.removeClass(u), layui.each(o, function (e, i) {
                    var o, f = "", y = "function" == typeof a[i];
                    if (a[i]) {
                        var o = y ? f = a[i](d, l) : !a[i][0].test(d);
                        if (f = f || a[i][1], o && "required" === i || o && d)return "tips" === c ? t.tips(f, r, {tips: 1}) : "alert" === c ? t.alert(f, {
                            title: "提示",
                            shadeClose: !0
                        }) : t.msg(f, {icon: 5, shift: 6}), n.android || n.ios || l.focus(), r.addClass(u), s = !0
                    }
                }), s)return s
