...
!function (t) {
    ...
    i.prototype.checkScroll = function () {
        ...
        this.bindEvent(t(window), "resize", function () {
            ...
            return "TEXTAREA" == h || "SELECT" == h || "OPTION" == h ? void t.stopPropagation() : (this.scroll(this.vslider.position().top - this.settings.wheelSpeed * e, this.hslider.position().left + this.settings.wheelSpeed * (-e), t), this.sliders.stop().fadeTo(this.settings.sliderOpacityTime, 1), window.clearTimeout(this.timer), this.timer = window.setTimeout(this.fixFn(function () {
